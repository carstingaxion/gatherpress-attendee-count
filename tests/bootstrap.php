 ...
 */
function gatherpress_attendee_count_filter_active_plugins_for_phpunit( $active_plugins ) {
...
tests_add_filter( 'site_option_active_sitewide_plugins', 'gatherpress_attendee_count_filter_active_plugins_for_phpunit' );
tests_add_filter( 'option_active_plugins', 'gatherpress_attendee_count_filter_active_plugins_for_phpunit' );
 ...
 * @return void
 */
function gatherpress_attendee_count_unit_test_load_plugin_file() {
	require_once TESTS_PLUGIN_DIR . '/plugin.php';
}

tests_add_filter( 'muplugins_loaded', 'gatherpress_attendee_count_unit_test_load_plugin_file' );
